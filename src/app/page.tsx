            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/40 to-transparent flex items-center p-12 md:p-20">
              <div className="glass p-8 md:p-12 rounded-2xl max-w-lg border-white/10 shadow-3xl">
                ...
                <p className="text-neutral-400 text-sm leading-relaxed mb-8">
                  Nossa inteligência artificial entende a física da luz, texturas orgânicas e
                  composição editorial para criar o desejo imediato de compra no seu cliente.
                </p>
        ...
        <section id="preços" className="py-32 px-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              >
                <div className="mb-10">
                  <h3 className="text-neutral-500 text-[10px] font-bold uppercase tracking-[0.3em] mb-4">
                    {plan.name}
                  </h3>
                  ...
                  <div className="text-primary font-bold text-xs mt-2 uppercase tracking-widest">
                    {plan.credits}
                  </div>
                </div>
                ...
                <ul className="space-y-4 mb-12 flex-grow">
                  {['Download Ilimitado', 'Qualidade Ultra HD', 'Remoção de Fundo'].map(f => (
                    <li
                      key={f}
                      className="flex items-center gap-3 text-xs text-neutral-400 font-medium"
                    >
        ...
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-2 md:grid-cols-4 gap-12 mb-20">
          ...
          {['Produto', 'Empresa', 'Legal', 'Social'].map(col => (
            <div key={col} className="flex flex-col gap-4">
              <span className="text-[10px] font-extrabold text-white uppercase tracking-[0.2em] mb-2">
                {col}
              </span>
              <a
                href="#"
                className="text-[10px] text-neutral-500 hover:text-white transition-colors uppercase tracking-widest font-bold"
              >
                Recursos
              </a>
              <a
