...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'De jeito nenhum. O Estúdio IA Pro realça o seu produto real. Nós trocamos o fundo e melhoramos a luz para que o cliente veja a qualidade real do seu produto, mantendo a fidelidade do que será entregue.',
  },
  {
